...
import ClassListItemsTable from '../tables/classlist/table'
...
const PDF = ({ data }: PDFProps) => {
    return (
        <Document author="Smart School LTD" title={"Class list: "+data.details} subject={"Class list: "+data.details}>
            <Page size="A4" style={styles.page}>
                <View style={styles.section}>
                    ...
                    <View style={styles.title}>
                        <Text>SEQUENCE LIST -- FICHE D'EVALUATION PAR CLASSE</Text>
                        <Text>Academic year / Année académique {data.year}</Text>
                    </View>
                    <View style={styles.details}>
                        <Text>Classe/Class: {data.details}</Text>
                        <Text>Subject/Matiere: _________________________</Text>
                        <Text>Teacher/Enseignant: _________________________</Text>
                    </View>

                    <ClassListItemsTable students={data.items}/>
                </View>
                {/* <View>
